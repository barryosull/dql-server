<?php namespace Infrastructure\App\EventLog\PDO;
...
class EventStreamLocker implements \App\EventLog\EventStreamLocker
{
    private $pdo;
        ...
        try {
            ...
            if ($this->is_timed_out($key, $now)) {
               $this->update_lock($key); 
                ...
                throw new \App\EventLog\EventStreamLockerException();
            }        
        }
    }
