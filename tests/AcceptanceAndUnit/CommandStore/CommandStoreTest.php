<?php namespace Test\AcceptanceAndUnit\CommandStore;
...
class CommandStoreTest extends \Test\TestCase 
{
    ...
    public function test_takes_in_data()
    {
        ...
        $this->mock_command_repo->store($data)
            ->shouldBeCalled();
