<?php namespace Test\AcceptanceAndUnit\Interpreter\Handler\Apply;

use App\Interpreter\Handler\Apply;

class InterpreterApplyOnInvariantTest extends \Test\AcceptanceAndUnit\Interpreter\TestCase
{
